...
INSERT INTO Cliente(ID_cliente, nombre_cliente, email, telefono, direccion, ciudad) VALUES(1, 'Nikita Megan Zurowski', 'nikitazurowski@cmail.carleton.ca', '991111111', 'Jr. Sanchez Cerro 1111', 'Lima');
INSERT INTO Cliente(ID_cliente, nombre_cliente, email, telefono, direccion, ciudad) VALUES(2, 'Sydney Mariah Kennedy', 'sydneykennedy@cmail.carleton.ca', '992222222', 'Jr. Sanchez Cerro 2222', 'Lima');
INSERT INTO Cliente(ID_cliente, nombre_cliente, email, telefono, direccion, ciudad) VALUES(3, 'Tycho Pulles', 't.pulles@student.maastrichtuniversity.nl', '99333333', 'Jr. Sanchez Cerro 3333', 'Lima');
INSERT INTO Cliente(ID_cliente, nombre_cliente, email, telefono, direccion, ciudad) VALUES(4, 'Bowien Dusseljee', 'bowien99@gmail.com', '994444444', 'Jr. Sanchez Cerro 4444', 'Lima');
INSERT INTO Cliente(ID_cliente, nombre_cliente, email, telefono, direccion, ciudad) VALUES(5, 'Kaï Fraussen', 'k.fraussen@student.maastrichtuniversity.nl', '995555555', 'Jr. Sanchez Cerro 5555', 'Lima');
INSERT INTO Cliente(ID_cliente, nombre_cliente, email, telefono, direccion, ciudad) VALUES(6, 'Morris Roman Colenbrander', '16088328@student.hhs.nl', '997777777', 'Jr. Sanchez Cerro 6666', 'Lima');
...
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(1, '229889@studenti.unimore.it', '999999999', 'Lima', 'Av. Salaverry 1111', 'Caña del Peru SAC', 'Hasnain Abbas');
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(2, '201709501@post.au.dk', '988888888', 'Lima', 'Av. Salaverry 2222', 'Cañito del Peru SAC', 'Emma Li Jiang Vestergaard');
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(3, 'celia.aubert@ieseg.fr', '977777777', 'Lima', 'Av. Salaverry 3333', 'Cañazo Peru SAC', 'Sophie Alix');
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(4, '229889@studenti.unimore.it', '966666666', 'Lima', 'Av. Salaverry 4444', 'Frutas del Peru SAC', 'Célia Maëlle Aubert');
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(5, 'Salome.Morand@etu.unige.ch', '955555555', 'Lima', 'Av. Salaverry 5555', 'Mercader Peru SAC', 'Salome Patricia Morand');
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(6, 'kandexer@mail.uni-mannheim.de', '944444444', 'Lima', 'Av. Salaverry 6666', 'Frutos del Peru SAC', 'Kai Christian Andexer');
INSERT INTO Proveedor(ID_proveedor, email, telefono, ciudad, direccion, razon_social, nombre_representante) VALUES(7, 'martin.bompuis@edu.esce.fr', '933333333', 'Lima', 'Av. Salaverry 7777', 'Frutitas Peru SAC', 'Martin Bompuis');
